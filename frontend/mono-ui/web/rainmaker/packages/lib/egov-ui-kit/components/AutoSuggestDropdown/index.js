...
var AutoSuggestDropdown = function (_React$Component) {
  ...
  function AutoSuggestDropdown() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = AutoSuggestDropdown.__proto__ || Object.getPrototypeOf(AutoSuggestDropdown)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var _this2 = _this,
          getLocalizedLabel = _this2.getLocalizedLabel;
      ...
      return (0, _commons.getTranslatedLabel)(label, localizationLabels);
  ...
  (0, _createClass3.default)(AutoSuggestDropdown, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          restProps = (0, _objectWithoutProperties3.default)(_props, ["onChange", "dataSource", "floatingLabelText", "className", "required", "value", "jsonPath", "errorMessage", "labelsFromLocalisation", "boundary", "dropDownData", "toolTip", "updateDependentFields", "toolTipMessage"]);
      ...
      if (labelsFromLocalisation) {
        list = dataSource && dataSource.reduce(function (result, item) {
      ...
      var items = list && list.length > 0 && list.sort(function (a, b) {
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, null)(AutoSuggestDropdown);