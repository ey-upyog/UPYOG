...
var DropDownUi = function DropDownUi(_ref) {
  var className = _ref.className,
      ...
      rest = (0, _objectWithoutProperties3.default)(_ref, ["className", "menuInnerDivStyle", "errorText", "localePrefix", "errorStyle", "value", "fullWidth", "labelStyle", "required", "dropDownData", "children", "selected", "onChange", "menuStyle", "id", "style", "floatingLabelText", "underlineStyle", "hintText", "hintStyle", "jsonPath", "dataFetchConfig", "errorMessage", "toolTip", "iconStyle", "autoWidth", "toolTipMessage", "updateDependentFields", "beforeFieldChange"]);

  var _ref2 = localePrefix || "",
      moduleName = _ref2.moduleName,
      masterName = _ref2.masterName;

  var getTransformedLocale = function getTransformedLocale(label) {
    return label.toUpperCase().replace(/[.:-\s\/]/g, "_");
  };

  var getDropdownLabel = function getDropdownLabel(value, label) {
    return typeof localePrefix === "string" ? _react2.default.createElement(_translationNode2.default, { label: getTransformedLocale(localePrefix) + "_" + getTransformedLocale(value) }) : (typeof localePrefix === "undefined" ? "undefined" : (0, _typeof3.default)(localePrefix)) === "object" ? _react2.default.createElement(_translationNode2.default, { label: getTransformedLocale(moduleName) + "_" + getTransformedLocale(masterName) + "_" + getTransformedLocale(value) }) : typeof localePrefix === "boolean" ? _react2.default.createElement(_translationNode2.default, { label: label }) : value;
  };
