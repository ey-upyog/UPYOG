...
function getSorting(order, orderBy, sortOnObject) {
  if (orderBy == sortOnObject) {
    return order === "desc" ? function (a, b) {
      return b[orderBy]['props']['children'] < a[orderBy]['props']['children'] ? -1 : 1;
    } : function (a, b) {
      return a[orderBy]['props']['children'] < b[orderBy]['props']['children'] ? -1 : 1;
    };
  }
  return order === "desc" ? function (a, b) {
          ...
          columnData.map(function (column) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(_translationNode2.default, { label: column.label })
              )
            );
          }, this)
        )
...
var TableUi = function (_React$Component2) {
  ...
  function TableUi(props) {
    ...
    var _this3$props = _this3.props,
        ...
        _this3$props$sortOnOb = _this3$props.sortOnObject,
        sortOnObject = _this3$props$sortOnOb === undefined ? "" : _this3$props$sortOnOb;
  ...
  (0, _createClass3.default)(TableUi, [{
    ...
    value: function render() {
      ...
      var _state = this.state,
          ...
          sortOnObject = _state.sortOnObject;
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              _TableBody2.default,
              null,
              data.sort(getSorting(order, orderBy, sortOnObject)).slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(function (n, index) {
