...
var RadioButtonUi = function RadioButtonUi(_ref) {
  var options = _ref.options,
      ...
      _ref$showFloatingLabe = _ref.showFloatingLabelText,
      showFloatingLabelText = _ref$showFloatingLabe === undefined ? false : _ref$showFloatingLabe,
  ...
  var getRadioComponent = function getRadioComponent() {
    if (showFloatingLabelText) {
      return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement(_translationNode2.default, { label: floatingLabelText, fontSize: 12, labelStyle: styles.labelStyle, bold: true }),
