...
var formConfig = {
    ...
    isSameAsPropertyAddress: {
      ...
      updateDependentFields: function updateDependentFields(_ref) {
        ...
        if (iscorrAddrSameProp) {
          ...
          dispatch((0, _actions.handleFieldChange)(formKey, "address", correspondingAddress));
        } else {
  ...
  beforeInitForm: function beforeInitForm(action, store, dispatch) {
    ...
    var designation = (0, _get3.default)(state, "common.prepareFormData.Properties[0].institution.designation", "");
    dispatch((0, _actions.setFieldProperty)("institutionAuthority", "designation", "value", designation));
    dispatch((0, _actions.handleFieldChange)("institutionAuthority", "designation", designation));
    return action;
  },
  action: "",
  redirectionRoute: "",
