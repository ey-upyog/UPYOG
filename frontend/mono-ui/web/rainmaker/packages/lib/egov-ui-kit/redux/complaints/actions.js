...
var checkUsers = function checkUsers(dispatch, state, actionHistory, hasUsers, tenantId) {
  if (hasUsers) {
    ...
    actionHistory.forEach(function (actions) {
      actions && actions.actions && actions.actions.forEach(function (action) {
        if (action.by) {
    ...
    if (employeeIds.length > 0) {
      ...
      var queryObject = tenantId ? [{ key: "tenantId", value: tenantId }, { key: "ids", value: value }] : [{ key: "ids", value: value }];
    ...
    if (userIds.length > 0) {
      ...
      if (id.length) dispatch(commonActions.fetchCitizens({ tenantId: JSON.parse((0, _localStorageUtils.getUserInfo)()).tenantId, userName: JSON.parse((0, _localStorageUtils.getUserInfo)()).userName, id: id }));
    }
  }
};
...
var fetchComplaints = exports.fetchComplaints = function fetchComplaints(queryObject) {
  ...
  return function () {
    var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(dispatch, getState) {
      var tenantId, isTenantId, payload;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 13:
              ...
              dispatch((0, _actions2.toggleSnackbarAndSetText)(true, {
                labelKey: _context2.t0.message,
                labelName: _context2.t0.message
              }, "error"));
