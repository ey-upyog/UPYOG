...
var commonReducer = function commonReducer() {
  ...
  switch (action.type) {
    ...
    case commonTypes.EMPLOYEE_FETCH_SUCCESS:
      var employeeById = (0, _commons.transformById)(action.payload.Employees, "id");
      return (0, _extends4.default)({}, state, {
        loading: false,
    ...
    case commonTypes.EMPLOYEE_TO_ASSIGN_FETCH_SUCCESS:
      var employeeToAssignById = (0, _commons.transformById)(action.payload.Employees, "id");
      return (0, _extends4.default)({}, state, {
        loading: false,
    ...
    case commonTypes.MDMS_FETCH_SUCCESS:
      ...
      var stateInfoById = action.payload.MdmsRes["common-masters"].StateInfo;
      ...
      var tenantInfo = action.payload.MdmsRes["tenant"]["tenantInfo"];
    ...
    case commonTypes.GENERAL_MDMS_FETCH_SUCCESS:
      ...
      return (0, _extends4.default)({}, state, {
        loading: false,
        generalMDMSDataById: (0, _commons.getTransformedDropdown)(generalMDMSDataById, ["PropertyType", "OwnerShipCategory", "UsageCategory"])
      });
