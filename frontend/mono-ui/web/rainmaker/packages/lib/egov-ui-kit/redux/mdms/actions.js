...
exports.fetchDocuments = exports.fetchSpecs = exports.documentDataFetchComplete = exports.dataFetchComplete = undefined;
...
var documentDataFetchPending = function documentDataFetchPending() {
  return {
    type: actionTypes.DOCUMENT_DATA_FETCH_PENDING
  };
};

var documentDataFetchComplete = exports.documentDataFetchComplete = function documentDataFetchComplete(payload) {
  return {
...
var documentDataFetchError = function documentDataFetchError(error) {
  return {
    ...
    values: rawSpecs.values.reduce(function (result, current) {
      if (current.name != "tenantId") {
        ...
        result["fields"] = (0, _extends4.default)({}, result["fields"], (0, _defineProperty3.default)({}, current.name, {
          ...
          dataFetchConfig: current.type === "singleValueList" || current.type === "AutocompleteDropdown" ? {
...
var fetchDocuments = exports.fetchDocuments = function fetchDocuments(tenantId) {
  var mdmsBody = {
    MdmsCriteria: {
      tenantId: tenantId,
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 2;
              _context2.next = 5;
              return (0, _api.httpRequest)(_endPoints.MDMS.GET.URL, _endPoints.MDMS.GET.ACTION, [], mdmsBody);
            ...
            case 9:
              ...
              dispatch(documentDataFetchError(_context2.t0.message));
