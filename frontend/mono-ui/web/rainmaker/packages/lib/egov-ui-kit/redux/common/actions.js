...
var normaliseEmployeeResponse = function normaliseEmployeeResponse(payload) {
  var response = (0, _cloneDeep2.default)(payload);
  var employeeNormalized = response.Employees.reduce(function (res, curr) {
    res.push((0, _extends3.default)({}, curr.user, curr));
    return res;
  }, []);

  /* Delete User */
  employeeNormalized.forEach(function (item) {
    delete item["user"];
  });
  ...
  return (0, _extends3.default)({}, response, { Employees: [].concat((0, _toConsumableArray3.default)(employeeNormalized)) });
};
