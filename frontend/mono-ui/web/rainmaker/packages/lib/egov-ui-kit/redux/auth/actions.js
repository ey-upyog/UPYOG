...
var userProfileUpdated = exports.userProfileUpdated = function userProfileUpdated() {
  ...
  (0, _localStorageUtils.setUserInfo)(JSON.stringify(user));
  (0, _localStorageUtils.setUserObj)(JSON.stringify(user));
...
var authenticated = exports.authenticated = function authenticated() {
  ...
  (0, _localStorageUtils.setUserInfo)(JSON.stringify(userInfo));
  (0, _localStorageUtils.setAccessToken)(accessToken);
  (0, _localStorageUtils.setRefreshToken)(refreshToken);
  (0, _localStorageUtils.setTenantId)(userInfo.tenantId);
  (0, _localStorageUtils.localStorageSet)("expires-in", expiresIn);
  (0, _localStorageUtils.localStorageSet)("last-login-time", lastLoginTime);
...
var searchUser = exports.searchUser = function searchUser() {
  return function () {
    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(dispatch, getState) {
      var state, _ref2, userName, tenantId, response;
      ...
      return _regenerator2.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              refreshToken = (0, _localStorageUtils.localStorageGet)("refresh-token");
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 12:
              ...
              dispatch((0, _actions.toggleSnackbarAndSetText)(true, { labelName: "OTP has been Resent", labelKey: "ERR_OTP_RESENT" }, "success"));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 5;
            return (0, _api.httpRequest)(_endPoints.AUTH.LOGOUT.URL, _endPoints.AUTH.LOGOUT.ACTION, [], { "access_token": authToken });
          ...
          case 8:
            (0, _localStorageUtils.clearUserDetails)();
