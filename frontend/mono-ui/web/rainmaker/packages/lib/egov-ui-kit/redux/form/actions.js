          ...
          switch (_context.prev = _context.next) {
            ...
            case 28:
              if (saveUrl == "/user/citizen/_create" && formResponse && formResponse.hasOwnProperty("UserRequest")) {
                (0, _localStorageUtils.setUserObj)(JSON.stringify(formResponse.UserRequest));
              }
            ...
            case 32:
              ...
              dispatch((0, _actions.toggleSnackbarAndSetText)(true, { labelName: message, labelKey: message }, "error"));
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 8:
              ...
              dispatch((0, _actions.toggleSnackbarAndSetText)(true, { labelName: _context2.t0.message, labelKey: _context2.t0.message }, "error"));
