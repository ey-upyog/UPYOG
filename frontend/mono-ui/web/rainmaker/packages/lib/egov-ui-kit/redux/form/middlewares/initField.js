  ...
  return function (next) {
    return function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(action) {
        var _action, type, dispatch, state, _action2, form, formKey, fields, formData, message;
                  ...
                  if (item.dataFetchConfig && !item.dataFetchConfig.isDependent) {
                    switch (item.type) {
                      case "singleValueList":
                        (0, _commons.fetchDropdownData)(dispatch, item.dataFetchConfig, formKey, key, state);
                    }
                  }
                });
                _context.next = 17;
