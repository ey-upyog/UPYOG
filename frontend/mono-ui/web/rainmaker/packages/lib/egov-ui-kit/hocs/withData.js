...
var withData = function withData(Component) {
    ...
    (0, _createClass3.default)(Wrapper, [{
      ...
      value: function componentDidMount() {
        var _props = this.props,
            ...
            fetchGeneralMDMSData = _props.fetchGeneralMDMSData;

        if ((0, _localStorageUtils.getAccessToken)()) {
  ...
  var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    ...
    return {
      ...
      fetchGeneralMDMSData: function fetchGeneralMDMSData() {
        return dispatch((0, _actions3.fetchGeneralMDMSData)(requestBody, "PropertyTax", (0, _commons.getGeneralMDMSDataDropdownName)()));
      }
    };
  };
