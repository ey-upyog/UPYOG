...
var AssessPay = function (_Component) {
  ...
  function AssessPay(props) {
    ...
    _this.getListItems = function () {
      ...
      return items = [{
        ...
        primaryText: _react2.default.createElement(_translationNode2.default, { label: "PT_ASSESSPAY_SEARCHPROP", fontSize: "16px", color: "#484848", labelStyle: { fontWeight: 500 } }),
  ...
  (0, _createClass3.default)(AssessPay, [{
    ...
    value: function render() {
      ...
      var userType = (0, _localStorageUtils.getUserInfo)().type;
