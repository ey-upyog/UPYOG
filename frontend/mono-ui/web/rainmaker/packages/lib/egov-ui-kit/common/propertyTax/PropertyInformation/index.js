...
var _initialiseProps = function _initialiseProps() {
  ...
  this.componentDidMount = function () {
    ...
    fetchGeneralMDMSData(requestBody, "PropertyTax", ["Floor", "UsageCategoryMajor", "UsageCategoryMinor", "UsageCategorySubMinor", "OccupancyType", "PropertyType", "UsageCategory"]);
    var pathname = location.pathname;
