...
var _PTInformation = require("./components/PTInformation");
    ...
    case "Paid-Disable":
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_translationNode2.default, { label: "PT_STATUS_COMMON_PAID", labelStyle: { marginLeft: "8px" }, color: "#22b25f" }),
    ...
    case "Pending":
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_translationNode2.default, { label: "PT_STATUS_COMMON_PENDING", labelStyle: { marginLeft: "8px" }, color: "#e74c3c" }),
          _react2.default.createElement(_components.Icon, { action: "navigation", name: "exclamation", style: styles.paidIconStyle, color: "#e74c3c" })
        ),
        _react2.default.createElement(
          "div",
          { style: { height: "30px", marginTop: "8px" } },
    ...
    case "Completed":
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { className: "assessment-displayInline", style: { marginTop: "8px" } },
          _react2.default.createElement(_translationNode2.default, { label: "PT_STATUS_COMMON_PARTIALLY_PAID", labelStyle: { marginLeft: "8px" }, color: "#22b25f" }),
          _react2.default.createElement(_components.Icon, { action: "navigation", name: "check", style: styles.paidIconStyle, color: "#22b25f" })
        ),
        _react2.default.createElement(
          "div",
...
var AssessmentList = function AssessmentList(_ref) {
  var properties = _ref.properties,
      ...
      totalBillAmountDue = _ref.totalBillAmountDue,
      documentsUploaded = _ref.documentsUploaded,
  ...
  return items.length == 0 ? _react2.default.createElement(_BlankAssessment2.default, {
    ...
    history: history
  }) : properties == null ? _react2.default.createElement(_PTList2.default, {
  ...
  }) : _react2.default.createElement(_PTInformation2.default, {
    properties: properties,
    items: getListItems(items, history, generalMDMSDataById),
    history: history,
    onItemClick: onItemClick,
