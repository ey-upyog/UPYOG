...
var ActionMenu = function (_Component) {
  ...
  function ActionMenu() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = ActionMenu.__proto__ || Object.getPrototypeOf(ActionMenu)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidMount = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
      var userInfo, fetchActionMenu, roles, roleCodes, bpaRolesArray, citizenRoles, rolesArray;
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              roleCodes = roles ? roles.map(function (role) {
                if (role.tenantId == (0, _localStorageUtils.getTenantId)()) {
                  return role.code;
                }
              }) : [];
              bpaRolesArray = ["BPA_ARCHITECT", "BPA_ENGINEER", "BPA_BUILDER", "BPA_STRUCTURALENGINEER", "BPA_TOWNPLANNER", "BPA_SUPERVISOR"];
              citizenRoles = ["CITIZEN"];

              if (process.env.REACT_APP_NAME === "Citizen") {
                rolesArray = ["CITIZEN"];

                roles.map(function (data) {
                  if (bpaRolesArray.includes(data.code)) return rolesArray.push(data.code);
                });
                if (rolesArray.length > 1) citizenRoles = rolesArray;else citizenRoles;
              }
  ...
  (0, _createClass3.default)(ActionMenu, [{
    ...
    value: function render() {
      ...
      return actionListArr && actionListArr.length > 0 ? _react2.default.createElement(_components2.default, {
