...
var LogoutDialog = function LogoutDialog(_ref) {
  ...
  var actions = [_react2.default.createElement(_components.Button, {
    ...
    label: _react2.default.createElement(_translationNode2.default, { buttonLabel: true, label: canceltext, color: "#FE7A51" }),
    backgroundColor: "#fff",
    ...
    label: _react2.default.createElement(_translationNode2.default, { buttonLabel: true, label: oktext, color: "#FE7A51" }),
    backgroundColor: "#fff",
    onClick: logout,
    style: { boxShadow: "none" }
  })];
  return _react2.default.createElement(_components.Dialog, {
    ...
    children: [_react2.default.createElement(_translationNode2.default, { label: body, color: "rgba(0, 0, 0, 0.6000000238418579)", labelStyle: { padding: "16px 0px 0px 12px" } })],
