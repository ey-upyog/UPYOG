...
var generateReceipt = function generateReceipt(role, details, generalMDMSDataById, receiptImageUrl, isEmployeeReceipt, extraData) {
  ...
  if (data) {
    ...
    var receiptPDF = _pdfmake2.default.createPdf(data);
    ...
    if (doNotDownloadReceipt !== true) {
      if ((0, _localStorageUtils.localStorageGet)("rd-propertyId") == details.propertyId && (0, _localStorageUtils.localStorageGet)("rd-assessmentNumber") == details.propertyDetails[0].assessmentNumber) {
        (0, _commons.downloadPDFFileUsingBase64)(receiptPDF, details.ReceiptNo + ".pdf");
