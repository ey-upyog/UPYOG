...
var getBusinessServiceNextAction = exports.getBusinessServiceNextAction = function getBusinessServiceNextAction(businessServiceName, currentAction) {
  var businessServiceData = JSON.parse(window.localStorage.getItem("businessServiceData")) || JSON.parse(window.localStorage.getItem("Employee.businessServiceData"));

  var data = businessServiceData && businessServiceData.filter(function (businessService) {
    return businessService.businessService == "PT.CREATE";
  });

  var _ref3 = data && data.length > 0 && data[0] || [],
      states = _ref3.states;

  if (states && states.length > 0) {
    states = states.filter(function (item, index) {
      if (item.state == currentAction && item.actions && item.actions.length > 0) {
        return item.actions;
      }
    });
    var actions = states && states.length > 0 && states[0].actions;
    var returnAction = '';
...
var callDraft = exports.callDraft = function () {
  var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(self) {
    ...
    var _self$state2, draftRequest, selected, _self$props2, form, location, common, search, prepareFormData, financialYearFromQuery, selectedownerShipCategoryType, _getInstituteInfo, instiObj, ownerArray;
...
var getTargetPropertiesDetails = exports.getTargetPropertiesDetails = function getTargetPropertiesDetails(propertyDetails, self) {
  ...
  var selectedPropertyDetails = propertyDetails;
...
var getImportantDates = exports.getImportantDates = function () {
  var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(self) {
        ...
        switch (_context4.prev = _context4.next) {
          ...
          case 5:
            ...
            if (ImpDatesResponse && ImpDatesResponse.MdmsRes.PropertyTax) {
              ...
              intrest = (0, _PTCommon.findCorrectDateObjPenaltyIntrest)(financialYearFromQuery, Interest);
              ...
              penalty = (0, _PTCommon.findCorrectDateObjPenaltyIntrest)(financialYearFromQuery, Penalty);
...
var getCalculationScreenData = exports.getCalculationScreenData = function () {
  var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(billingSlabs, tenantId, self) {
    "pt-calculator-v2/billingslab/_search";
    var prepareFormData, unitsArray, filteredUnitsArray, mapIdWithIndex, billingSlabResponse, finalData;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            filteredUnitsArray = unitsArray && unitsArray.filter(function (item) {
              return item !== null;
            });
          ...
          case 13:
            finalData = mapIdWithIndex.mappedIds.reduce(function (res, curr) {
              var floorNo = filteredUnitsArray[curr.index].floorNo;
...
var getHeaderLabel = exports.getHeaderLabel = function getHeaderLabel(selected, role) {
  switch (selected) {
    ...
    case 3:
      return _react2.default.createElement(_translationNode2.default, { containerStyle: { marginTop: 12 }, fontSize: "16px", color: "#484848" });
    case 4:
      return _react2.default.createElement(_translationNode2.default, {
        containerStyle: { marginTop: 12 },
        fontSize: "16px",
...
var removeAdhocIfDifferentFY = exports.removeAdhocIfDifferentFY = function removeAdhocIfDifferentFY(property, fY) {
  (0, _lodash.set)(property, "Properties[0].propertyDetails[0].adhocExemption", null);
  (0, _lodash.set)(property, "Properties[0].propertyDetails[0].adhocExemptionReason", null);
  (0, _lodash.set)(property, "Properties[0].propertyDetails[0].adhocPenalty", null);
  (0, _lodash.set)(property, "Properties[0].propertyDetails[0].adhocPenaltyReason", null);
  return property;
};

var getSortedTaxSlab = exports.getSortedTaxSlab = function getSortedTaxSlab(estimateResponse) {
  if (estimateResponse && estimateResponse.Calculation && estimateResponse.Calculation.length > 0) {
    if (estimateResponse.Calculation[0].taxHeadEstimates && estimateResponse.Calculation[0].taxHeadEstimates.length > 0) {
      var taxHeadKeys = ["PT_TAX", "PT_CANCER_CESS", "PT_TIME_REBATE", "PT_TIME_PENALTY", "PT_TIME_INTEREST", "PT_OWNER_EXEMPTION", "PT_ROUNDOFF", "PT_UNIT_USAGE_EXEMPTION", "PT_FIRE_CESS"];
      var tempArray = estimateResponse.Calculation[0].taxHeadEstimates;
      if (tempArray && tempArray.length > 0) {
        var tempArray1 = [];
        taxHeadKeys.map(function (key) {
          var itemKeys = {};
          itemKeys = tempArray[tempArray.findIndex(function (item) {
            return item.taxHeadCode.indexOf(key) !== -1;
          })];
